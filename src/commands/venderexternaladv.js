...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('external-advanced')
        .setDescription('🎯 Menu de vendas - NEW External Advanced'),

    async execute(interaction, client, dbMySQL) {
        try {
            const [rows] = await dbMySQL.query("SELECT * FROM produtos WHERE slug = 'external-advanced'");
            ...
            console.error('❌ Erro no comando external-advanced:', error);
